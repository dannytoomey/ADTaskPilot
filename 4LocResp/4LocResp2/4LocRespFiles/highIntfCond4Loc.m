...
%problem - this version displays a red circle among a red square and blue
%squares. it should show a red circle among a red square and blue circle
%for the target and distractors to share two dimensions. 

%problem 2 - taskorder typo in highTaskOrder=2

function highIntfCond4Loc(sjNum)
