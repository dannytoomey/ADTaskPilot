...
function practiceCond4Loc(sjNum)
...
for cond=1:numCond
    ...
    if cond==1
        ...
        for task=1:numTask
            ...
            ignoreTones=['Respond to the location of \n'...
                'the red circle with the E, X, I, and M keys \n'...
                '(E = upper left, X = lower left \n'...
    ...
    if cond==2
        ...
        for task=1:numTask
            ...
            Screen('TextFont',window,'Courier');
            ignoreTones=['Respond to the location of \n'...
                'the red shape with the E, X, I, and M keys \n'...
                '(E = upper left, X = lower left \n'...
                'I = upper right, and M = lower right) \n'...
                'ignore the tones.'];
            respTones=['Respond to the location of \n'...
