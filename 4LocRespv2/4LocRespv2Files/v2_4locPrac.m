...
%retest - compare to ANT, k Task, pencil and paper task (o span, digit
%span, cognitive failures questionairre)
...
for cond=1:numCond
    ...
    if cond==1
        ...
        for task=1:numTask
            ...
            ignoreTones=['Respond to the location of the \n'...
                'RED CIRLCE with the E, V, I, and V keys \n'...
    ...
    if cond==2
        ...
        for task=1:numTask
            ...
            Screen('TextFont',window,'Courier');
            ignoreTones=['Respond to the location of the \n'...
                'RED SQUARE with the E, V, I, and N keys \n'...
                '(E = upper left, I = upper right \n'...
                'V = lower left, and N = lower right) \n'...
                'and IGNORE the TONES.'];
            respTones=['Respond to the location of the \n'...
...
DrawFormattedText(window,['Please wait for the \n' ... 
    'the administrators cue to begin. \n \n' ...
