...
for task=1:numTask
    for cue=1:numCue
        ...
        block1=allStroopTask(task).thisTaskData(cue).thisCondData(1).thisBlockTrials(blockTrials).thisTrialData;
        block2=allStroopTask(task).thisTaskData(cue).thisCondData(2).thisBlockTrials(blockTrials).thisTrialData;
        block3=allStroopTask(task).thisTaskData(cue).thisCondData(3).thisBlockTrials(blockTrials).thisTrialData;
        block4=allStroopTask(task).thisTaskData(cue).thisCondData(4).thisBlockTrials(blockTrials).thisTrialData;
        block5=allStroopTask(task).thisTaskData(cue).thisCondData(5).thisBlockTrials(blockTrials).thisTrialData;
        block6=allStroopTask(task).thisTaskData(cue).thisCondData(6).thisBlockTrials(blockTrials).thisTrialData;
        block7=allStroopTask(task).thisTaskData(cue).thisCondData(7).thisBlockTrials(blockTrials).thisTrialData;
        block8=allStroopTask(task).thisTaskData(cue).thisCondData(8).thisBlockTrials(blockTrials).thisTrialData;
