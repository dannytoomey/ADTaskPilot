...
for task=1:numTask
    for cue=1:numCue
        ...
        if sjNum==99
            ...
            data = [block1,block2];
            blockWM=allMedTask(task).thisTaskData(cue).thisCueCondData(2).thisBlockWM;
            ...
            blockWM=allMedTask(task).thisTaskData(cue).thisCueCondData(8).thisBlockWM;
            blockWMload=blockWM(1:5,:);
            blockWMprobe=blockWM(6:10,:);
        end
