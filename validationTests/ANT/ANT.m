...
function [nt1Acc,nt2Acc,nt2AccGivenT1Acc,trialMatrix,targets] = ANT(subjectNumber,logFileName,mySOA,practice,laptopDebug)
...
%         end
        ...
        if go==' '
            ...
            for trial = 1:nTrials
                ...
                %make the stream
                [myWindows,arrowDir,CueCode] = make_stream(myWindows,thisCon,thisCue,tarLoc,centerX,centerY,window);
...
%===============================================
function drawCue(thisWin,loc,centerX,centerY,color)
...
%===============================================
function [myWindows,arrowDir,CueCode] = make_stream(myWindows,thisCon,thisCue,tarLoc,centerX,centerY,window)
